 ...
 * Created on February 25th, 2022, 2:45 pm
...
int *fillIdx(int);
void mrkSort(int **trangl, int *array,int *indx,int size);
...
int main(int argc, char** argv) {
    ...
    mrkSort(trangl, col,indx,rowSize);//Sort the columns with an index
...
void mrkSort(int **trangl, int *array,int *indx,int size){
    for(int pos=0;pos<size-1;pos++){
        for(int lst=pos+1;lst<size;lst++){
            if(array[indx[pos]]>array[indx[lst]]){
                array[indx[pos]]=array[indx[pos]]^array[indx[lst]];
                array[indx[lst]]=array[indx[pos]]^array[indx[lst]];
                array[indx[pos]]=array[indx[pos]]^array[indx[lst]];

                int * temp = trangl[indx[pos]];
                trangl[indx[pos]]=trangl[indx[lst]];
                trangl[indx[lst]]=temp;
